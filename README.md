...
### Instructions
There two levels to this challenge, but both have been implemented on the same web page. To try the functionalities, download the `index.html` file and all the files in the `UFO-level-1-2` folder. Then, open `index.html` with your preferred web browser. 
